...
import { IndianRupee, User, Users, Plus } from 'lucide-react';
            ...
            {USER_MODES.map((mode) => (
              ...
              >
                ...
                <div className={`flex items-center justify-center w-8 h-8 rounded-full flex-shrink-0 ${
                  ...
                  {mode.id === 'personal' ? <User size={14} /> : <Users size={16} />}
                </div>
                <div>
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8 md:p-10 rounded-2xl shadow-lg shadow-blue-600/20 text-white relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col gap-2">
            <div className="flex items-center gap-2 text-blue-100/80 mb-2 font-medium tracking-wide">
              <IndianRupee size={20} className="text-white bg-white/20 p-1 rounded-md backdrop-blur-sm" /> 
              TOTAL INCOME
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-[#F8FAFC] border border-gray-200 rounded-xl pl-8 pr-4 py-3 text-slate-700 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium placeholder:font-normal placeholder:text-gray-400 font-mono"
                />
              </div>
            </div>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <select 
                ...
                className="w-full bg-[#F8FAFC] border border-gray-200 rounded-xl px-4 py-3 text-slate-700 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium appearance-none cursor-pointer font-sans"
              >
