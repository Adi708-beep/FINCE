...
const Home = ({ activeLayout = 1 }) => {
      ...
      <div className="w-12 border-r border-slate-900 flex flex-col items-center py-4 justify-between bg-slate-900/50">
        <div className="flex flex-col items-center gap-5 w-full">
          ...
          <div className="flex flex-col items-center gap-3 w-full px-2">
            ...
            <div className="p-2 rounded-lg text-slate-650 hover:bg-slate-900 w-full flex justify-center">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
              </svg>
            </div>
  ...
  // Fallback layout 5 definition for incomplete layouts in Fince_back
  const renderLayout5 = () => (
    <div className="relative py-12 flex flex-col items-center text-center gap-8">
      {renderHeroTextPill("Centered Column Stack")}
      <div className="relative group flex items-center justify-center z-10 w-full max-w-4xl pr-8 md:pr-14 pb-10">
