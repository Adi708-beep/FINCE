...
router.get('/', authenticateToken, async (req, res) => {
  ...
  try {
    ...
    // Set query filter based on family sharing status
    ...
    transactions.forEach(t => {
      ...
      const key = `${monthNames[tDate.getMonth()]} ${tDate.getFullYear()}`;
    ...
    const monthlyExpenses = transactions
      .filter(t => t.date.getMonth() === thisMonth && t.date.getFullYear() === thisYear)
